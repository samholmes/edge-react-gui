...
import { getExchangeRate, getSelectedWallet, getTokenExchangeDenomination } from '../../modules/UI/selectors.js'
...
export const Request = connect(
  (state: RootState): RequestStateProps | RequestLoadingProps => {
    ...
    const primaryExchangeDenomination: GuiDenomination = getTokenExchangeDenomination(state, currencyCode)
