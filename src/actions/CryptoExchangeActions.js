...
import { getTokenExchangeDenomination } from '../modules/UI/selectors'
...
export const selectWalletForExchange = (walletId: string, currencyCode: string, direction: 'from' | 'to') => async (dispatch: Dispatch, getState: GetState) => {
  ...
  const primaryExchangeDenomination: GuiDenomination = getTokenExchangeDenomination(state, cc, wallet)
