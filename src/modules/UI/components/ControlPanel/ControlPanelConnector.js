...
import { getExchangeRate, getSelectedWallet, getTokenExchangeDenomination } from '../../../UI/selectors.js'
...
const mapStateToProps = (state: RootState) => {
  ...
  try {
    if (guiWallet && currencyCode) {
      ...
      primaryExchangeDenomination = getTokenExchangeDenomination(state, currencyCode)
